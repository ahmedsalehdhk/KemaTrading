    ...
    <section className='outer-container' id='about'>
      <div className="inner-container padding w-full">
        ...
        <div className='flex flex-col md:flex-row md:gap-10'>
          <h1 className='font-baskerville capitalize text-4xl md:w-2/5 leading-normal margin-small'>kema trading - bangladeshi <span className='text-neutral-400 italic'>tannery</span> since 1998</h1>
