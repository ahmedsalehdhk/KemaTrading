  ...
  return (
    <nav className='outer-container fixed top-0 left-0 z-50 bg-white shadow-sm'>
        <div className="inner-container w-full padding-x py-3 flex justify-between items-center">
            ...
            <a href='/' className="logo text-center hover:cursor-pointer select-none">
                <h1 className='font-playfair-display capitalize text-2xl whitespace-nowrap'>kema trading</h1>
